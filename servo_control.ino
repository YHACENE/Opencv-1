...
#define  screenmaxx   320   // max screen horizontal (x)resolution最大屏幕水平（x）分辨率
...
#define  servopinx   9   // digital pin for servo x数字引脚
...
int posx = 0;
int posy = 0;
int incx = 10;  // significant increments of horizontal (x) camera movement水平（x）相机运动的增量
